                    ...
                    <form onSubmit={handleRegisterNest}>
                        ...
                        <div className='label-by-qtd'>
                            <div className='format-label'>
                                ...
                                <input type="number" className="form-input" placeholder='Quantidade de ovos Eclodidos' value={qtdOvosEclodidos} onChange={(e) => setQtdOvosEclodidos(e.target.value)} />
                            </div>
                            
                            <div className='format-label'>
                                <label>Quantidade de ovos não Eclodidos</label>
                                <input type="number" className="form-input" placeholder='Quantidade de ovos não eclodidos' value={qtdOvosNEclodidos} onChange={(e) => setQtdOvosNEclodidos(e.target.value)}/>
                            </div>
                            
                            <div className='format-label'>
                                <label>Quantidade de Natimortos</label>
                                <input type="number" className="form-input" placeholder='Quantidade de natimortos' value={natimorto} onChange={(e) => setNatimorto(e.target.value)}/>
                            </div>
                        </div>
