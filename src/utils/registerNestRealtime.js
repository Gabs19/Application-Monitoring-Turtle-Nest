...
export default async function registerRealtime(nomeMarcador,location,especie,equipe,qtdOvosEclodidos,qtdOvosNEclodidos,natimorto,dataEclosao,localizacao,dataDesova,totalOvos,obs) {
